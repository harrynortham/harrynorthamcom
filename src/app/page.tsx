  ...
  return (
    <div className="mx-auto max-w-7xl px-4 text-center">
      ...
      <div className="intro-text py-8 ">
        ...
        <div className="description mt-4 text-pretty">A web developer in Gibraltar with high level experience in Front-End. Producing quality work, crafting digital journeys that captivate users.  </div>
